...
model TEDSloop_allmodes_test_3WV_exp2023_f
  ...
  Modelica.Blocks.Sources.RealExpression FM_201(y=-sensor_m_flow4.m_flow)
    annotation (Placement(transformation(extent={{44,-98},{66,-76}})));
equation
...
end TEDSloop_allmodes_test_3WV_exp2023_f;
