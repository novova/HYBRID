...
equation
  ...
  connect(T_charge_outlet.port_b, sensor_m_flow4.port_b) annotation (Line(
        points={{154,-51},{148,-51},{148,-78},{92,-78},{92,-110},{80,-110}},
        color={0,127,255}));
  connect(T_discharge_outlet.port_a, sensor_m_flow.port_a) annotation (Line(
        points={{154,-3},{146,-3},{146,4},{134,4},{134,52},{84,52},{84,48}},
        color={0,127,255}));
  annotation (
